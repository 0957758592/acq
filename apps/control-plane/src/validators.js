...
export const SCHEMAS = {
  ...
  'shop.buy': schema({ shopId: str, platform: str, country: str, query: str, categoryId: num.integer().positive(), quantity: num.integer().positive(), strategy: str.oneOf(['cheapest', 'reliable']), maxUnitPriceRub: num.positive(), includeGroups: arr.of(str), excludeGroups: arr.of(str), excludeNames: arr.of(str), confirm: bool, idempotenceId: str }),
  ...
  'email.identity.list': schema({ category: str, cursor: str.nullable(), limit: num.integer().positive() }),
  ...
  // Accounts
  'account.status': schema({ accountId: str, platform: str, cursor: str.nullable(), limit: num.integer().positive() }),
